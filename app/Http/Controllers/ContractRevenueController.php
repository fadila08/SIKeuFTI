...
class ContractRevenueController extends Controller
{
    ...
    {
        //ambil data ledger yang akun pendapatan kontrak sajaaw
        ...
        ->where('coas.acc_name', 'like', 'pendapatan kontrak%')
        ->groupBy('id_project')
        ->get();
        ...
        return view('contractRevenues.index', ['contractRevenues' => $data]);
    }
}
