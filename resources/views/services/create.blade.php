                ...
                <div class="card bg-secondary shadow">
                    <div class="card-header bg-white border-0">
                        <div class="row align-items-center">
                            <div class="col-8">
                                <h3 class="mb-0" style="color:#028090">{{ __('Service') }}</h3>
                            </div>
                        ...
                        <form method="post" action="{{ route('services.store') }}" autocomplete="off">
                            ...
                            <div class="pl-lg-4">
                                <div class="form-group{{ $errors->has('service_name') ? ' has-danger' : '' }}">
                                    <label class="form-control-label" for="input-service-name">{{ __('Service Name') }}</label>
                                    <input type="text" name="service_name" id="input-service-name" class="form-control form-control-alternative{{ $errors->has('service_name') ? ' is-invalid' : '' }}" placeholder="{{ __('Service Name') }}" value="{{ old('service_name') }}" required autofocus>
