@extends('layouts.app', ['title' => __('Acccount Group')])
                ...
                <div class="card shadow">
                    <div class="card-header border-0">
                        <div class="row align-items-center">
                            <div class="col-8">
                                <h3 class="mb-0">{{ __('Accounts Group') }}</h3>
                            </div>
                            <div class="col-4 text-right">
                                <a href="{{ route('coa.index') }}" class="btn btn-sm btn-primary">{{ __('Back to COA') }}</a>
                                <a href="{{ route('accGroup.create') }}" class="btn btn-sm btn-primary">{{ __('Add Account Group') }}</a>
                            </div>
                        </div>
                    </div>
