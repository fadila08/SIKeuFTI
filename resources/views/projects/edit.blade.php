...
@section('content')
    @include('projects.partials.header', ['title' => __('Edit Project')])   
                        ...
                        <form method="post" action="{{ route('project.update', $project->id) }}" autocomplete="off">
                            ...
                            <div class="pl-lg-4">
                                <div class="form-group{{ $errors->has('project_name') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="project_name" id="input-project-name" class="form-control form-control-alternative{{ $errors->has('project_name') ? ' is-invalid' : '' }}" placeholder="{{ __('Project Name') }}" value="{{ old('project_name', $project->project_name) }}" required autofocus>
                                ...
                                <div class="form-group{{ $errors->has('project_started') ? ' has-danger' : '' }}">
                                    ...
                                    <div class="input-group input-group-alternative">
                                        ...
                                        <input class="form-control datepicker" placeholder="Select date" type="text" value="{{ old('project_started', $project->project_started) }}" name="project_started" id="input-project-started">
                                    </div>
                                </div>
                                <div class="form-group{{ $errors->has('project_ended') ? ' has-danger' : '' }}">
                                    ...
                                    <div class="input-group input-group-alternative">
                                        ...
                                        <input class="form-control datepicker " placeholder="Select date" type="text" value="{{ old('project_ended', $project->project_ended) }}" name="project_ended" id="input-project-ended">
                                    </div>
                                </div>
                                <div class="form-group{{ $errors->has('project_cost') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="project_cost" id="input-project-cost" class="form-control form-control-alternative{{ $errors->has('project_cost') ? ' is-invalid' : '' }}" placeholder="{{ __('Project Cost') }}" value="{{ old('project_cost', $project->project_cost) }}" required autofocus>
